                    ...
                    <div className="grid gap-6">
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                autoComplete="email"
                                value={email}
                                className="mt-1 block w-full bg-surface-container-lowest border-surface-container-high focus-visible:ring-primary/20 focus-visible:border-primary"
                                readOnly
                            />
                            <InputError
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="password_confirmation" className="font-semibold text-secondary">
                                Confirm password
                            </Label>
                            <PasswordInput
